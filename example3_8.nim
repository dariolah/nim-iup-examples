...
# https://www.tecgraf.puc-rio.br/iup/examples/tutorial/example3_8.c
...
proc mainProc =
  var
    ...
    sub_menu_file, file_menu, item_exit, item_open, item_saveas, btn_open, btn_save: iup.PIhandle
    sub_menu_edit, edit_menu, item_find, item_goto, btn_find: iup.PIhandle
  ...
  discard iup.setCallback(item_copy, "ACTION", cast[Icallback](item_copy_action_cb))
  discard iup.setCallback(item_paste, "ACTION", cast[Icallback](item_paste_action_cb))
  discard iup.setCallback(item_cut, "ACTION", cast[Icallback](item_cut_action_cb))
  discard iup.setCallback(item_delete, "ACTION", cast[Icallback](item_delete_action_cb))
  discard iup.setCallback(item_select_all, "ACTION", cast[Icallback](item_select_all_action_cb))
