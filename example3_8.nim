...
proc mainProc =
  var
    ...
    sub_menu_file, file_menu, item_exit, item_open, item_saveas, btn_open, btn_save: niup.PIhandle
    sub_menu_edit, edit_menu, item_find, item_goto, btn_find: niup.PIhandle
