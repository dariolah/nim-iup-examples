...
proc view_fit_rect(canvas_width:int, canvas_height:int, image_width:int, image_height:int, view_width:ptr int, view_height:ptr int) =
  var
...
proc item_print_action_cb(item_print:PIhandle):cint =
  ...
  if image != nil:
    ...
    view_fit_rect(canvas_width - 2 * margin_width, canvas_height - 2 * margin_height,
                  ...
                  addr view_width, addr view_height)
