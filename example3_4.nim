...
proc mainProc =
  ...
  var sub_menu_file, file_menu, item_exit, item_open, item_saveas: iup.PIhandle
  var sub_menu_edit, edit_menu, item_find, item_goto: iup.PIhandle
  ...
  item_find = iup.item("Find..", nil)
  item_goto = iup.item("Go To...", nil)
